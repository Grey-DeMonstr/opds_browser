...
// Release signing is opt-in: without android/key.properties the release build
// falls back to the debug key so `flutter run --release` still works on a
// machine that has no keystore. CI writes this file from repository secrets.
...
android {
    namespace = "monster.greyde.opds_browser"
